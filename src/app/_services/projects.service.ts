...
export class ProjectsService {
    ...
    projects: Project[] = [
        ...
        {id: 3, name: "Coming Soon.", summary: "Coming Soon.", description: 'Coming Soon.', projectLink: '', tags: [Tag.JAVASCRIPT, Tag.POSTGRESQL], pictures: ["../../assets/Temp.png", "../../assets/Temp2.png"]},
